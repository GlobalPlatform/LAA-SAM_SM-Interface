...
[Messages](LAA__Terminology_And_Definitions.md#Message) are the data exchanged between the [SAM SM](LAA__Terminology_And_Definitions.md#SAMSM) and the [Local Applet Assistant](LAA__Terminology_And_Definitions.md#LAA). The definition, the meaning and sequence of [Messages](LAA__Terminology_And_Definitions.md#Message) is described in the [Messages section](#messages).
...
The GET DATA command is defined in [SAM Configuration](LAA__References.md#SAMCONF)  section 6.4
...
A [sessionId](LAA__Terminology_And_Definitions.md#sessionId) is generated by the LAA in this scenario. The DELETE_SAM_SERVICE command is defined in [SAM Configuration](LAA__References.md#SAMCONF)  section 6.14
...
The DELETE_SAM_SERVICE command is defined in [SAM Configuration](LAA__References.md#SAMCONF)  section 6.14
...
Optionnaly when an [End User](LAA__Terminology_And_Definitions.md#EU) want to display information about a specific SAM Service, the LAA MAY retrieve extra information in the CRS application (see [SAM Configuration](LAA__References.md#SAMCONF) section 6.5)
ASP RID in a GET STATUS command MAY be used to filter SAM Service.

### End user interactions for user intent

[End User](LAA__Terminology_And_Definitions.md#EU) intent is acquired as defined in [SAMREQ](LAA__References.md#SAMREQ). This intent is acquired in advance or in real time. This process depends on the device and is implementation specific.
...
see [OpenAPI specification](../spec/laa.yaml) ([Viewer](https://globalplatform.github.io/LAA-SAM_SM-Interface)) for the details
